...
public class Game 
{
    ...
    public Game() 
    {
        ...
        parser = new Parser();
        roomStack = new Stack<Room>(); //arraylist of rooms
    ...
    private void goRoom(Command command) 
    {
        if(!command.hasSecondWord()) {
            ...
            //the current room is also not the teleporter room
        ...
        if (nextRoom == null) {
            ...
            if(nextRoom instanceof TransporterRoom){
                ...
                currentRoom.passedRooms(gameRooms);
                ...
                System.out.println(currentRoom.getLongDescription());
                System.out.println("Exit through any door to be transported to a random room");
                roomStack.push(currentRoom);
                return;
            } 
    ...
    private void charge(Command command){
        ...
        if(command.hasSecondWord()){
            ...
            if(inventory.empty()){
            System.out.println("You need a beamer first");
            return;
            }       
            if(((inventory.peek()).getClass() == Beamer.class)) {
                ...
                if(((Beamer)inventory.peek()).isCharged()){
                    ...
                    System.out.println("You charge your beamer");
                }
    ...
    private void fire(Command command){
        ...
        if(command.hasSecondWord()){
            ...
            if(inventory.empty()){
              System.out.println("What're you trying to fire?");
              return;
            }
            ...
            if(((inventory.peek()).getClass() == Beamer.class)){
                ...
                if(((Beamer)inventory.peek()).isCharged()){
                    System.out.println("Pew pew! You have fired your beamer");
