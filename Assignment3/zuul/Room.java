...
public class Room 
{
    ...
    private boolean isTransportRoom; //all room's have the ability to become the random room teleported to
    ...
    public void setTransportRoom(){
    
        this.isTransportRoom = true;
    ...
    public String getLongDescription()
    {
        ...
        for(Item item:items){
            ...
            returnString += " A "+  item.itemDescription();
        }
    ...
    public void passedRooms(ArrayList<Room> rooms){
        ArrayList<Room> grooms = new ArrayList<>(rooms);
